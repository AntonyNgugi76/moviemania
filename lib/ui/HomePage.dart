              ...
              child: Column(
                ...
                children: [
                  ...
                  ListTile(
                    ...
                    title: Text('Home',style: GoogleFonts.raleway(textStyle: TextStyle())),
                  ),
                  ListTile(
                    onTap: () {},
                    leading: Icon(Icons.account_circle_rounded),
                    title: Text('Profile',style: GoogleFonts.raleway(textStyle: TextStyle()),),
                  ),
                  ListTile(
                    onTap: () {},
                    leading: Icon(Icons.favorite),
                    title: Text('Favourite Movies',style: GoogleFonts.raleway(textStyle: TextStyle())),
                  ),
                  ListTile(
                    onTap: () {},
